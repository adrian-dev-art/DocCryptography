        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mail bg-white border border-purple-500">
                <div class="header py-4 px-6 relative bg-purple-500">
                    <i class="fas fa-envelope text-indigo-400 bg-white p-2 px-3 rounded-full text-xl absolute right-6 top-6 border-2 border-purple-500 transition-transform hover:rotate-12"></i>
                </div>
                    ...
                    <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                        <div class="menu-card">
                            <a href="{{ route('send-file') }}" class="block">
                                <div class="hover:bg-indigo-500 hover:bg-opacity-10 rounded-lg p-4">
                                    <div class="mail-icon danger bg-indigo-600 text-primary rounded-full w-12 h-12 flex items-center justify-center">
                        ...
                        <div class="menu-card">
                            <a href="{{ route('received-files') }}" class="block">
                                <div class="hover:bg-indigo-500 hover:bg-opacity-10 rounded-lg p-4">
                                    <div class="mail-icon  bg-indigo-600 success bg-primary-200 text-primary rounded-full w-12 h-12 flex items-center justify-center">
                        ...
                        <div class="menu-card">
                            <a href="{{ $signature ? route('signatures.show', $signature->id) : route('signatures.create') }}" class="block">
                                <div class="hover:bg-indigo-500 hover:bg-opacity-10 rounded-lg p-4">
                                    <div class="mail-icon  bg-indigo-600 warning bg-primary-200 text-primary rounded-full w-12 h-12 flex items-center justify-center">
                        ...
                        <div class="menu-card">
                            <a href="{{ route('scan.form') }}" class="block">
                                <div class="hover:bg-indigo-500 hover:bg-opacity-10 rounded-lg p-4">
                                    <div class="mail-icon bg-indigo-600 text-primary rounded-full w-12 h-12 flex items-center justify-center">
